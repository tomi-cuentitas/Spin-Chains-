...
def HierarchBasis_vardim_proj_evs(Hamiltonian, fixed_ops_list, rho_ref, K_ref, range_derived_series_orders, 
                                     temp_ref, temp_rho, 
                                     generating_operator,
                                     init_coeff_list,
                                     timespan, label_ops,
    ...
    for deg_solva in range_derived_series_orders:
        ...
        depth_and_seed_ops = [(1, op) for op in fixed_ops_list] + [(deg_solva, generating_operator)]
